...
export default function (opts: { radius?: number | undefined; color?: THREE.Color | number |string | undefined; speed?: number | undefined; opacity?: 1 | undefined; angle?: number | undefined; position?: THREE.Vector3 | undefined; rotation?: { x: number; y: number; z: number; } | undefined; }) {
    const {
        radius = 50,
        color = "#fff",
        speed = 1,
